...
const ClickedZoneTodayHighlights = (props) => {
    ...
    const collectionsByRevenueStream = {
        ...
        tooltip: {
            ...
            pointFormat: '<span style="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' +
                'Collected Revenue <b>NGN {point.y}</b><br/>' +
    ...
    return (
        <>
            ...
            <button class="btn btn-primary openZoneCanvas d-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mapZone">
                open Marker Conent Canavas
            </button>

            <div class="offcanvas offcanvas-start" tabindex="-1" id="mapZone" aria-labelledby="offcanvasExampleLabel">
                ...
                <div class="offcanvas-body">
                                    ...
                                    <div class="col-12">
                                        <div class="card height-calc-twenty-4">
                                            ...
                                            <div class="card-footer bg-money p-4 bg-opacity-75 border-top">
                                                <p class="text-light opacity-75">Achieved <strong>5.56%</strong> of their <strong>NGN 23,456</strong> target</p>
                                    ...
                                    <div className='col-6'>
                                        <div class="alert alert-success border-success border-2" role="alert">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="mb-0 "><strong class="fw-semibold"><span class="the-clicked-address "></span>NGN 10,000</strong></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-6'>
                                        <div class="alert alert-success border-success border-2" role="alert">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="mb-0 "><strong class="fw-semibold"><span class="the-clicked-address "></span>NGN 2,890</strong></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-6'>
                    ...
                    <div className='card shadow-none border border-success border-2'>
                        <div className='card-body p-3'>
                            <div class="d-flex"><div class="overflow-hidden me-auto"><h5 class="card-title text-truncate mb-4"><a href="javascript: void(0);" class="text-body">Revenue Source Composition of Emmanuel's Collections</a></h5><p class="text-muted text-truncate mb-0 d-none">23 KM</p></div><div class="align-self-end ms-2 d-none"><p class="text-muted mb-0"><i class="mdi mdi-clock text-muted align-middle me-1"></i> ETA 20 Min</p></div></div>
                            ...
                            <div class="col-6">
                                <div class="alert alert-info border-info border-2" role="alert">
                                    <div>
                                        ...
                                        <h5 class="mb-0 "><strong class="fw-semibold"><span class="the-clicked-address "></span>NGN 2,890</strong>
                                        </h5>
                                    </div>
                                </div>
                            </div>
...
export default ClickedZoneTodayHighlights;