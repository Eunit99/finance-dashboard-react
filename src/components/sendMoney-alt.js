...
const SendMoney=()=>{
    ...
    const sendMoneyStart=async(event)=>{
        ...
        console.log("Amount sending is NGN:"+sendAmount)
        //alert(sendAmount)
        //alert(mpesaPhoneNum)
                          ...
                          <div className="recepient-account payment-panel payment-active-panel">
                              ...
                              <div>
                                  ...
                                  <div className="form-floating mb-3">
                                      ...
                                      <label for="floatingnameInput">NGN</label>
                                  </div>
                                      ...
                                      <div className="accordion-item">
                                          ...
                                          <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                              <div className="accordion-body">
                                                  <div>
                                                      <p>
                                                          A payment request of <strong className="text-black">{StdFunctions.kenyaCurrency(sendAmount)}</strong> plus <strong className="text-black">NGN 50 as transaction</strong> fee will be sent to the MPESA number you enter below.
                                                      </p>
                                                  </div>
                                          ...
                                          <h2 className="accordion-header" id="headingTwo">
                                              <button className="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                  ...
                                                  <div className="d-flex flex-column">
                                                      ...
                                                      <p className="mb-0 p-0"> <small>My Wallet Bal: <strong>NGN {parentWalletBal}</strong></small></p>
                                          ...
                                          <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                              <div className="accordion-body">
                                                  <div className="text-muted">
                                                      <p><strong className="text-black">KSH 250</strong> plus <strong className="text-black">NGN 50 as transaction fee</strong> will be deducted from your Guardian Blink Wallet and the amount will be credited to <strong className="text-black">Alex's Blink Wallet Account.</strong></p>
                          ...
                          <div className="d-none transaction-summary payment-panel">
                              ...
                              <div className="border p-4 rounded ">
                                  ...
                                  <div className="my-wallet-confirmation d-none">
                                      <p className="text-muted mt-4 "><strong className="text-uppercase text-black">NGN 300</strong> will be deducted from your guardian blink wallet and amount will be credited to <strong className="text-capitalize text-black">Alex's pocket money account</strong>.</p>
