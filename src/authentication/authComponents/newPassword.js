        ...
        <div className="mt-4">
          <form autocomplete="off" className="needs-validation" novalidate onSubmit={settingTheNewPassword}>
            ...
            <div className="mb-3">
              ...
              <input onChange={(event) => setNewPassword(event.target.value)} maxLength="4" required type="password" className="form-control" id="userpassword" placeholder="4 Digit Pass Code"
              />
            ...
            <div className="mb-3">
              ...
              <input onChange={(event) => setConfirmPassword(event.target.value)} maxLength="4" required type="password" className="form-control" id="confirmpassword" placeholder="Confirm Pass Code"
              />
              <div className="invalid-feedback text-capitalize">
                Pass code mismatch
              </div>
            ...
            <div className="mt-4 d-grid d-flex">
              ...
              {canClick ? (
                <button type="button" className="btn btn-primary waves-effect waves-light flex-grow-1">Finish</button>
              ) : (
