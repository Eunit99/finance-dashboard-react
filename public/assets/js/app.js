! function(s) {
    ...
    function a(e) {
        document.getElementById("header-lang-img") && ("UGX" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/uganda.png" : "USD" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/us.jpg" : "NGN" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/kenya.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "assets/images/flags/russia.jpg"));
        var theCurrency = e;
    ...
    s("#side-menu").metisMenu(), s("#vertical-menu-btn").on("click", function(e) { e.preventDefault(),$('.portal-title').toggleClass('d-none'), s("body").toggleClass("sidebar-enable"), 992 <= s(window).width() ? s("body").toggleClass("vertical-collpsed") : s("body").removeClass("vertical-collpsed") }), s("#sidebar-menu a").each(function() {
