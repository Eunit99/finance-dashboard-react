    ...
    <>
      ...
      <div className="container-fluid">
        ...
        <div className="row d-sm-none d-md-flex">
          <div className="col-12">
            <h4 className="text-black pt-0 pl-0 pb-3 p-3  fw-medium m-0 text-capitalize">Hello, {"Emmanuel"}</h4>
          </div>
        </div>
                  ...
                  <div class="card-body bg-money">
                    ...
                    <div class="text-muted mt-0">
                      <div class="d-flex flex-column">
                        ...
                        <h5 class="text-white fw-semibold text-uppercase text-black fw-bold">NGN 12,890</h5>
                        <div>
